import { _getProvider, getApp, _removeServiceInstance, SDK_VERSION, _registerComponent, registerVersion } from '@firebase/app';
...
/** Creates a new Query instance with the options provided. */ function on$1(t, e, n, s, i, r, o, u) {
...
function Zs(t) {
    ...
    // visible for testing
    (n.endAt)), on$1(e, i, o, r, u, "F" /* First */ , c, a);
}
...
// PORTING NOTE: Multi-Tab only.
function kc(t) {
    return on$1(t.path, t.collectionGroup, t.orderBy, t.filters, t.limit, "F" /* First */ , t.startAt, t.endAt);
}
