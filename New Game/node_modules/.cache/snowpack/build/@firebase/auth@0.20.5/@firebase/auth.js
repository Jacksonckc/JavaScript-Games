import { ErrorFactory, deepEqual, getModularInstance, base64Decode, querystring, querystringDecode, extractQuerystring, isMobileCordova, isReactNative, FirebaseError, isIE, isBrowserExtension, getUA, createSubscribe, isEmpty } from '@firebase/util';
import { _getProvider, getApp, SDK_VERSION, _registerComponent, registerVersion } from '@firebase/app';
